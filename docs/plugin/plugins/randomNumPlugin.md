...
| ---- | ---- | ---- | ---- | ---- |
| ThreeKingdomsRandom | StandardPlugin | '判定' | None | 三国杀判定 |
| RandomNum | StandardPlugin | '\[...\]d\[...\]' | None | 生成随机数 |
| TarotRandom | StandardPlugin | '塔罗' / '占卜' | None | 生成三张随机塔罗牌 |
...
bot> 【回复上文】投掷次数要为正哦~
222> 300d2
bot> 【回复上文】对不起，我只有20个骰子~
333> 塔罗
bot> 【图片】
```

![](../../images/plugins/tarot.png)

## 3. 代码分析

代码位于 `plugins/randomNum.py`
