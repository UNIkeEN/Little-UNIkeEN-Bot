...
| ---- | ---- | ---- | ---- | ---- |
| WeiboHotSearch | StandardPlugin | '微博热搜' / '热搜' / 'wbrs' / '-wbrs' | None | 获取微博热搜 |
| BaiduHotSearch | StandardPlugin | '百度热搜' / 'bdrs' / '-bdrs' | None | 获取百度热搜 |
| ZhihuHotSearch | StandardPlugin | '知乎热搜' / 'zhrs' / '-zhrs' | None | 获取知乎热搜 |
...
微博热搜图片：
![](../../images/plugins/wbrs.png)

知乎热搜图片：
![](../../images/plugins/zhrs.png)
